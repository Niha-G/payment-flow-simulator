...
/**
 * Producer wiring for outbound {@link PaymentEvent}s. Timeouts are bounded so a
 * missing broker fails fast instead of blocking the caller.
 */
@Configuration
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, PaymentEvent> producerFactory() {
        ...
        // Cap how long send() blocks waiting on metadata when no broker is up.
